                    ...
                    <div className="w-full md:w-[90vw] lg:w-[75vw] flex flex-col md:flex-row justify-between bg-white rounded-2xl border border-[#D4D4D4] p-4 sm:p-6 gap-6">
                        ...
                        <div className="flex items-start gap-3 flex-1">
                            ...
                            <div className="flex flex-col">
                                <p className="text-lg sm:text-xl text-[#777777] poppins-medium font-semibold">Total Properties</p>
                                ...
                                <div className="flex items-end gap-3 mt-1">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <p className="poppins-medium text-[#777777] text-xs sm:text-sm">Growth in properties</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="w-full h-32 sm:h-40 mt-2">
                                    <ResponsiveContainer width="100%" height="100%">
                                        <LineChart data={data}>
                                            ...
                                            <Tooltip />
                                            <Line type='linear' dataKey="customers" stroke="darkgreen" strokeWidth={3} dot={{ r: 4 }} activeDot={{ r: 8 }} />
                                        </LineChart>
                                    </ResponsiveContainer>
                                </div>
                            </div>

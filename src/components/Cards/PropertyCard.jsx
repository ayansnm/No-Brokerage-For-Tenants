  ...
  return (
    <div onClick={()=>navigate("/PropertyDetails")} className="w-full cursor-pointer bg-white border border-gray-200 rounded-xl h-auto sm:h-[160px] flex flex-col sm:flex-row items-stretch px-3 py-2 shadow-sm gap-3 sm:gap-0">
      ...
      <div className="flex flex-col justify-between w-full sm:w-[45%] px-0 sm:px-4 h-full py-1 sm:py-2">
        ...
        <div className="text-xs sm:text-[12px] text-gray-500">750 Sqft · Ground floor</div>
        ...
        <a href="#" className="text-blue-500 text-xs sm:text-[12px] mt-1 inline-block">
          View Details →
        </a>
      </div>

      {/* Right Actions - Full width on mobile, 20% on desktop */}
      <div className="w-full sm:w-[20%] flex flex-row sm:flex-col justify-between items-center sm:items-end h-auto sm:h-full py-2 gap-2 sm:gap-0">
        <button className="bg-[#1b4332] text-white text-xs sm:text-[12px] font-medium px-3 sm:px-4 py-[6px] rounded-full hover:bg-[#15452d] transition whitespace-nowrap">
          Contact Broker
        </button>
